...
export const MONSTERS = {
  ...
  goblin: {
    ...
    emoji: '👺',
    tier: 1,
    baseStats: { maxHp: 30, attack: 6, defense: 2, speed: 7 },
    xpReward: 10,
  ...
  rat: {
    ...
    emoji: '🐀',
    tier: 1,
    baseStats: { maxHp: 20, attack: 4, defense: 1, speed: 10 },
    xpReward: 5,
  ...
  skeleton: {
    ...
    emoji: '💀',
    tier: 1,
    baseStats: { maxHp: 35, attack: 8, defense: 3, speed: 4 },
    xpReward: 12,
  ...
  slime: {
    ...
    emoji: '🟢',
    tier: 1,
    baseStats: { maxHp: 25, attack: 3, defense: 5, speed: 2 },
    xpReward: 6,
  ...
  giant_bat: {
    ...
    emoji: '🦇',
    tier: 1,
    baseStats: { maxHp: 18, attack: 5, defense: 1, speed: 14 },
    xpReward: 7,
  ...
  orc: {
    ...
    emoji: '👹',
    tier: 2,
    baseStats: { maxHp: 60, attack: 14, defense: 6, speed: 5 },
    xpReward: 25,
  ...
  wolf: {
    ...
    emoji: '🐺',
    tier: 2,
    baseStats: { maxHp: 45, attack: 12, defense: 4, speed: 12 },
    xpReward: 20,
  ...
  zombie: {
    ...
    emoji: '🧟',
    tier: 2,
    baseStats: { maxHp: 80, attack: 10, defense: 8, speed: 2 },
    xpReward: 22,
  ...
  giant_spider: {
    ...
    emoji: '🕷️',
    tier: 2,
    baseStats: { maxHp: 55, attack: 16, defense: 5, speed: 9 },
    xpReward: 28,
  ...
  harpy: {
    ...
    emoji: '🦅',
    tier: 2,
    baseStats: { maxHp: 40, attack: 18, defense: 3, speed: 14 },
    xpReward: 24,
  ...
  troll: {
    ...
    emoji: '🧌',
    tier: 3,
    baseStats: { maxHp: 120, attack: 20, defense: 10, speed: 4 },
    xpReward: 50,
  ...
  ghost: {
    ...
    emoji: '👻',
    tier: 3,
    baseStats: { maxHp: 50, attack: 25, defense: 2, speed: 15 },
    xpReward: 45,
  ...
  dark_knight: {
    ...
    emoji: '🖤',
    tier: 3,
    baseStats: { maxHp: 100, attack: 22, defense: 15, speed: 6 },
    xpReward: 55,
  ...
  minotaur: {
    ...
    emoji: '🐂',
    tier: 3,
    baseStats: { maxHp: 140, attack: 24, defense: 12, speed: 5 },
    xpReward: 60,
  ...
  vampire: {
    ...
    emoji: '🧛',
    tier: 3,
    baseStats: { maxHp: 80, attack: 28, defense: 8, speed: 10 },
    xpReward: 52,
  ...
  demon: {
    ...
    emoji: '😈',
    tier: 4,
    baseStats: { maxHp: 180, attack: 35, defense: 15, speed: 10 },
    xpReward: 80,
  ...
  golem: {
    ...
    emoji: '🗿',
    tier: 4,
    baseStats: { maxHp: 200, attack: 28, defense: 18, speed: 3 },
    xpReward: 85,
  ...
  wraith: {
    ...
    emoji: '👤',
    tier: 4,
    baseStats: { maxHp: 100, attack: 40, defense: 5, speed: 18 },
    xpReward: 75,
  ...
  lich: {
    ...
    emoji: '🧙‍♂️',
    tier: 4,
    baseStats: { maxHp: 150, attack: 45, defense: 10, speed: 8 },
    xpReward: 90,
  ...
  titan: {
    ...
    emoji: '🗿',
    tier: 4,
    baseStats: { maxHp: 300, attack: 32, defense: 30, speed: 2 },
    xpReward: 95,
  ...
  dragon: {
    ...
    tier: 3,
    isBoss: true,
    baseStats: { maxHp: 400, attack: 40, defense: 20, speed: 8 },
    xpReward: 250,
  ...
  demon_lord: {
    ...
    tier: 4,
    isBoss: true,
    baseStats: { maxHp: 600, attack: 55, defense: 25, speed: 12 },
    xpReward: 400,
  ...
  lich_king: {
    ...
    tier: 4,
    isBoss: true,
    baseStats: { maxHp: 800, attack: 60, defense: 30, speed: 10 },
    xpReward: 500,
