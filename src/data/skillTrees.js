  ...
  rogue: {
    ...
    skills: [
      ...
      },
      {
        ...
        type: SKILL_TYPE.PASSIVE,
        tier: 0,
        passive: { type: 'stat_bonus', stats: { speed: 5 } },
      },
      {
        id: 'rogue_precision',
        name: 'Precision',
  ...
  ranger: {
    ...
    skills: [
      ...
      },
      {
        ...
        type: SKILL_TYPE.PASSIVE,
        tier: 0,
        passive: { type: 'stat_bonus', stats: { speed: 4 } },
      },
      {
        id: 'ranger_steady_aim',
        name: 'Steady Aim',
        emoji: '🎯',
        description: '+15% damage to full HP targets.',
        type: SKILL_TYPE.PASSIVE,
        tier: 0,
        passive: { type: 'opener_bonus', damageBonus: 15 },
      },
